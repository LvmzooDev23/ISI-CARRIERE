        ...
        <div class="max-w-3xl w-full mx-auto grid gap-4 grid-cols-1">
            ...
            <div class="flex flex-col justify-center p-4 bg-gray-800 border-gray-800 shadow-md hover:shodow-lg rounded-2xl">
                <div class=" text-gray-400 flex items-center ">
                    ...
                    <p> A free repository for community components at
                        <a href="https://tailwindcomponents.com/u/aji" class="underline hover:underline-none ml-1 text-green-300" target="_blank">tailwindcomponets</a>
                    </p>
