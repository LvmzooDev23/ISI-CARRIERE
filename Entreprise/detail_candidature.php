...
if (isset($_SESSION['etp'])) {
    $candidature = getCandidatureById($_GET['id']);
} else {
    header("Location: ../index.php");
}
if (isset($_POST["valider"])) {
    validerCandidature($candidature["idCandidature"]);
    header("Location: gestion-candidatures.php");
}
if (isset($_POST["rejeter"])) {
    refuserCandidature($candidature["idCandidature"]);
    header("Location: gestion-candidatures.php");
}
?>
<!DOCTYPE html>
        ...
        <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
            ...
            <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                ...
                <div class="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <h1 class="text-3xl font-bold pt-8 lg:pt-0"><?= $candidature["prenomEtudiant"] . " " . $candidature["nomEtudiant"] ?></h1>
                    ...
                    <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                        ...
                        </svg> Profil Recherché: &nbsp;<span><?= mb_strtoupper($candidature["titreStage"], 'UTF-8') ?></span>
                    </p>
                    <p class="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
                        ...
                        </svg>Adresse Mail : &nbsp;<span><?= $candidature["mailEtudiant"] ?></span>
                    </p>
                    <p class="pt-8 text-sm">
                        <span><b><u>Description</u></b></span>:
                        <?= $candidature["niveauEtudiant"] ?>
                    </p>
                    <p class="pt-8 text-sm">
                        <b><u>Statut:</u></b>
                        <span class="bg-<?php echo ($candidature['statutCandidature'] == "ATT") ? "yellow" : (($candidature['statutCandidature'] == "ACC") ? "green" : "red"); ?>-500">
                            <?php if ($candidature["statutCandidature"] == "ATT") {
                                echo " EN ATTENTE";
                            } elseif ($candidature["statutCandidature"] == "ACC") {
                                echo " ACCEPTE";
                            } else {
                                echo " NON RETENU";
                            } ?>
                    ...
                    <p class="pt-8 text-sm">
                        <span><b><u>Niveau</u></b></span>:
                        <?= $candidature["niveauEtudiant"] ?> <br>
                        <span><b><u>Filière</u></b></span>:
                        <?= $candidature["specialiteEtudiant"] ?> <br>
                        <span><b><u>Contacts</u></b></span>:
                        <?= $candidature["mailEtudiant"] . " - (+221) " . $candidature["telephoneEtudiant"] ?>
                    </p>

                    <div class="pt-12 pb-8">
                        <form action="" method="post">
                            <button name="valider" class="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
                                Valider
                            </button>
                            <button name="rejeter" class="bg-red-700 hover:bg-red-900 text-white font-bold py-2 px-4 rounded-full">
                                Rejeter
                            </button>
                            <a href="gestion-candidatures.php" class="bg-zinc-700 hover:bg-zinc-900 text-white font-bold py-2 px-4 rounded-full">
                                ANNULER
                            </a>
                        </form>
                    </div>
