...
if (isset($_POST['connexion'])) {
    ...
    login_entreprise($email, $password);
...
<body class="bg-midnight">
    ...
    <div class="bg-gray-300 p-0 sm:p-20">
        <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl mt-20">
            <h1 class="text-2xl text-center font-bold mb-8 underline">Formulaire Connexion Entreprise</h1>
            <form id="form" novalidate method="post">
                <div class="relative z-0 w-full mb-5">
                    ...
                    <label for="email" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">email@nomentreprise.com</label>
                ...
                <p class="mt-5 text-center">Pas encore inscrit ? <a class="text-sky-500 text-center font-bold underline" href="add_entreprise.php">inscrivez-vous ici</a></p>
            </form>
        </div>
    </div>
