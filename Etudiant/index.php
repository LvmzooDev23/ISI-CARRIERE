...
<div class="bg-gray-100 p-0 sm:p-20">
    <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl mt-20">
        ...
        <form id="form" novalidate method="post">
            ...
            <button id="button" type="button" class="w-full px-6 py-3 mt-3 text-lg text-white transition-all duration-150 ease-linear rounded-lg shadow outline-none bg-blue-950 hover:bg-blue-500 hover:shadow-lg focus:outline-none">
                SE CONNECTER
            </button>
